...
extractAll('MusicSimilarity/HTML/EN/plugins/MusicSimilarity/html/js', '.js')
updateAll('MusicSimilarity/HTML/EN/plugins/MusicSimilarity/html/lang', '.json')
